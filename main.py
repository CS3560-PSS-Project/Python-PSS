...
def main():
    ...
    task1 = RecurringTask("task1", "study", "20220528", "12:00", 75, "20220801", "daily")
    # task1.display()
    task2 = TransientTask("task2", "visit", "20220801", "11:15", 45)
    # task2.display()
    task3 = AntiTask("task3", "cancellation", "20220701", "12:00", 75)
    # task3.display()
    task4 = TransientTask("task4", "visit", "20220511", "13:25", 60)
    task5 = RecurringTask("task5", "study", "20220301", "12:00", 75, "20220430", "daily")
    task6 = AntiTask("task6", "cancellation", "20220421", "12:00", 75)
    task7 = TransientTask("task7", "visit", "20220421", "11:20", 60)
    task8 = AntiTask("task8", "cancellation", "20220801", "12:00", 75)
    task9 = AntiTask("task9", "cancellation", "20220725", "12:00", 75)
